...
const Calculator = () => {
 ...
 const toggleView = () => {
  ...
  const displayValue = (value, prefix = '', suffix = '') => isNaN(value) ? '-' : `${prefix}${formatNumberWithCommas(value)}${suffix}`;
    ...
    <div className="page-container">
      ...
      <div className="data-edit-page">
        ...
        <div className="banner-category">
            {showLT && <h3 className="banner-kpi">{displayValue(cashFlowLT.toFixed(0), '$ ')}</h3>}
            {showST && <h3 className="banner-kpi">{displayValue(cashFlowST.toFixed(0), '$ ')}</h3>}
            <span>Monthly Cash Flow</span>
          </div>
          <div className="banner-category">
            {showLT && <h3 className="banner-kpi">{displayValue(capRateLT.toFixed(2), '', '%')}</h3>}
            {showST && <h3 className="banner-kpi">{displayValue(capRateST.toFixed(2), '', '%')}</h3>}
            <span>Cap Rate</span>
          </div>
          <div className="banner-category">      
